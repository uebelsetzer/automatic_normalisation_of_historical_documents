...
def arguments():
    parser = argparse.ArgumentParser(description="Fine-tune OPUS model")
    parser.add_argument("-m", "--model", default="Helsinki-NLP/opus-mt-tc-big-itc-itc", help="Folder path: path to OPUS model that is going to be fine-tuned.")
...
def preprocess_function(examples):
    ...
    references = tokenizer(text_target=targets, max_length=max_target_length, truncation=True)

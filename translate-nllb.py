...
def arguments():
    ...
    parser.add_argument("-o", "--output", default="results/medical_nllb_ft.txt", help="Output file.")
    ...
    for src_text in src_list:
        ...
        if is_too_long:
            ...
            for st in src_text:
                ...
                translated_text = model.generate(**s, forced_bos_token_id=tokenizer.lang_code_to_id["por_Latn"])
